...
public class MovieController {
    ...
    @GetMapping("/releaseDate/{date}")
    public ResponseEntity<List<Movie>> getMoviesByReleaseDate(@PathVariable String date){
        return new ResponseEntity<>(movieService.getMoviesByReleaseDate(date), HttpStatus.OK);
    }
